...
<head>
    ...
    <fmt:bundle basename="content">
        ...
        <fmt:message key="car.seats" var="seats"/>
...
<c:choose>
    ...
    <c:when test="${validation eq 'Invalid seats'}">
        <p class="error">${validation}</p>
    </c:when>
    ...
    <div class="container">
        <div class="editor_block">
            ...
            <div class="editor_block__content">
                ...
                ${seats}: <input class="content_editor" name="seats_editor" type="number" value="${car.seats}"
                                 pattern="[0-9]{7}" required/><br/>
                ...
                ${year}: <input id="ye" class="content_editor" name="year_editor" type="number"
                                value="${car.manufacturedYear}" required/><br/>
                ...
                VIN: <input id="ve" id="vin_editor" class="content_editor" name="vin_editor" value="${car.vin}"
                            required><br/>
                ${plate}: <input id="pe" class="content_editor" name="plate_editor" value="${car.plate}"><br/>
                ${price}: <input id="pre" class="content_editor" name="price_editor" type="number" min="0" step="0.1"
    ...
    <div class="preview" id="preview">
        <div class="car_block">
            ...
            <div class="car_block__characteristics">
                ...
                ${seats}: <span id="seats">${car.seats}</span><br/>
