        ...
        <div class="content">
            <ul class="pagination">
                <c:if test="${currentPage != 1}">
                    <li class="page-item">
                        <a class="page-link"
                           href="Controller?command=gotocarcommentspage&data_id=${car.id}&current_page=${currentPage-1}">${previous}</a>
                    </li>
                </c:if>
                ...
                <c:forEach begin="1" end="${requestScope.pages_amount}" var="i">
                    <c:choose>
                        ...
                        <c:otherwise>
                            <li class="page-item">
                                <a class="page-link"
                                   href="Controller?command=gotocarcommentspage&data_id=${car.id}&current_page=${i}">${i}</a>
                            </li>
                        </c:otherwise>
                    </c:choose>
                </c:forEach>
                ...
                <c:if test="${currentPage lt requestScope.pages_amount}">
                    <li class="page-item">
                        <a class="page-link"
                           href="Controller?command=gotocarcommentspage&data_id=${car.id}&current_page=${currentPage+1}">${next}</a>
                    </li>
                </c:if>
            </ul>
        </div>
